...
namespace TradoProjet.Pages
{
	...
	public partial class PageChoisirGiveObjet : ContentPage
	{
		...
		public PageChoisirGiveObjet (TradoObjet[] tradoObjetGets, TradoObjet[] tradoObjetGives, string myCourriel, string hisCourriel)
		{
			InitializeComponent ();
        ...
        protected override async void OnAppearing()
	    {
            ...
            var resultat = liste.Where(x => x.CourrielUsager.ToUpper().Equals(MyCourriel.ToUpper())).ToList();
